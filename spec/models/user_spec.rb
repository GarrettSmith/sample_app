...
describe User do
  ...
  it "should require a name" do
    unnamed_user = User.new(@attr.merge( :name => "" ))
    unnamed_user.should_not be_valid
  end
  ...
  it "should reject dublicate email addresses" do
    ...
    User.create!(@attr)
    dublicate_user = User.new(@attr)
    dublicate_user.should_not be_valid
  end

  it "should reject dublicate mail up to case" do
  ...
  describe "password encryption" do
    ...
    it "should not be the same as the unencrypted password" do
    ...
    describe "authentication method" do
      ...
      it "should return nil when no user has the given email" do
        nonexistant_user = User.authenticate("wrong@example.com", @attr[:password])
        nonexistant_user.should be_nil
      end

      it "should return the user when email/password match" do
